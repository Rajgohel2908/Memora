...
export function Error404({
    ...
    postcardAlt = 'Memora Memories Postcard',
            ...
            <div className="flex flex-col items-center">
                <div className="relative mb-16">
                    ...
                    <div className="relative z-10">
                        <div className="relative p-3 shadow-2xl rotate-[4deg] hover:rotate-0 transition-transform duration-300 bg-white dark:bg-[#242120]">
                ...
                <div className="text-center max-w-2xl">
                    ...
                    <Button asChild className="rounded-xl px-8 py-2 font-sans">
                        <Link to={backButtonHref} className="flex items-center gap-2 w-[200px]">
                            {backButtonLabel}
